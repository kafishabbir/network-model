...
simulate::Property generate_property()
{
	...
	//~ property.constant_radius_contrast = 0.0;
	//~ property.constant_mu1_by_mu2 = 0.0;
	//~ property.constant_mu_scale = 0.0;
	//~ property.constant_length_scale = 0.0;
	property.capture_frequency_in_volume_fraction = 0.1;
	property.volume_max_to_inject = 0.4;
	property.n_periods = 2;
	property.inlet_pressure = 1e11;

	return property;
}

visualize::Property generate_visual_property()
{
...
{
	auto states = simulate::Menu(generate_property());
