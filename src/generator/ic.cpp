...
Nodes generator::Ic::generate_v_nodes_for_square_lattice(
...
Tubes generator::Ic::generate_v_tubes_for_square_lattice(
	const int n_rows_tube,
	const int n_cols_tube
)
{
