...
edit:
	geany -i  src/exe/simulate.cpp src/global/decl.h src/global/dst.h src/ic/geometry-base.cpp src/ic/geometry-base.h src/ic/geometry-flow.cpp src/ic/geometry-flow.h src/ic/geometry-rand.cpp src/ic/geometry-rand.h src/io/file-write.cpp src/io/file-write.h src/nst/fluid.cpp src/nst/fluid.h src/nst/node.cpp src/nst/node.h src/nst/state.cpp src/nst/state.h src/nst/tank.cpp src/nst/tank.h src/nst/tube.cpp src/nst/tube.h src/simulate/menu.cpp src/simulate/menu.h src/simulate/step0-preparation.cpp src/simulate/step0-preparation.h src/simulate/step1-tube-flow-coefficient.cpp src/simulate/step1-tube-flow-coefficient.h src/simulate/step10-measure.cpp src/simulate/step10-measure.h src/simulate/step2-pressure.cpp src/simulate/step2-pressure.h src/simulate/step3-velocity.cpp src/simulate/step3-velocity.h src/simulate/step4-time-step.cpp src/simulate/step4-time-step.h src/simulate/step5-displacement.cpp src/simulate/step5-displacement.h src/simulate/step6-pour-into-node.cpp src/simulate/step6-pour-into-node.h src/simulate/step7-inject-evacuate.cpp src/simulate/step7-inject-evacuate.h src/simulate/step8-distribute.cpp src/simulate/step8-distribute.h src/simulate/step9-update-tube-mpos.cpp src/simulate/step9-update-tube-mpos.h src/utility/math.cpp src/utility/math.h src/utility/measure.cpp src/utility/measure.h src/utility/random.cpp src/utility/random.h src/utility/time.cpp src/utility/time.h src/visualize/draw.cpp src/visualize/draw.h src/visualize/flow.cpp src/visualize/flow.h src/visualize/flow-verification-label.cpp src/visualize/flow-verification-label.h src/visualize/latex.cpp src/visualize/latex.h src/visualize/menu.cpp src/visualize/menu.h src/visualize/property.cpp src/visualize/property.h src/visualize/re-scale-state-for-plot.cpp src/visualize/re-scale-state-for-plot.h


run/simulate.exe: run/build/exe_simulate.o run/build/ic_geometry-base.o run/build/ic_geometry-flow.o run/build/ic_geometry-rand.o run/build/io_file-write.o run/build/nst_fluid.o run/build/nst_node.o run/build/nst_state.o run/build/nst_tank.o run/build/nst_tube.o run/build/simulate_menu.o run/build/simulate_step0-preparation.o run/build/simulate_step1-tube-flow-coefficient.o run/build/simulate_step10-measure.o run/build/simulate_step2-pressure.o run/build/simulate_step3-velocity.o run/build/simulate_step4-time-step.o run/build/simulate_step5-displacement.o run/build/simulate_step6-pour-into-node.o run/build/simulate_step7-inject-evacuate.o run/build/simulate_step8-distribute.o run/build/simulate_step9-update-tube-mpos.o run/build/utility_math.o run/build/utility_measure.o run/build/utility_random.o run/build/utility_time.o run/build/visualize_draw.o run/build/visualize_flow.o run/build/visualize_flow-verification-label.o run/build/visualize_latex.o run/build/visualize_menu.o run/build/visualize_property.o run/build/visualize_re-scale-state-for-plot.o
	g++  run/build/exe_simulate.o run/build/ic_geometry-base.o run/build/ic_geometry-flow.o run/build/ic_geometry-rand.o run/build/io_file-write.o run/build/nst_fluid.o run/build/nst_node.o run/build/nst_state.o run/build/nst_tank.o run/build/nst_tube.o run/build/simulate_menu.o run/build/simulate_step0-preparation.o run/build/simulate_step1-tube-flow-coefficient.o run/build/simulate_step10-measure.o run/build/simulate_step2-pressure.o run/build/simulate_step3-velocity.o run/build/simulate_step4-time-step.o run/build/simulate_step5-displacement.o run/build/simulate_step6-pour-into-node.o run/build/simulate_step7-inject-evacuate.o run/build/simulate_step8-distribute.o run/build/simulate_step9-update-tube-mpos.o run/build/utility_math.o run/build/utility_measure.o run/build/utility_random.o run/build/utility_time.o run/build/visualize_draw.o run/build/visualize_flow.o run/build/visualize_flow-verification-label.o run/build/visualize_latex.o run/build/visualize_menu.o run/build/visualize_property.o run/build/visualize_re-scale-state-for-plot.o -o run/simulate.exe
