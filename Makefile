...
run/build/visualize_trash-flow-file-out.o: src/visualize/trash-flow-file-out.cpp src/visualize/trash-flow-file-out.h src/global/dst.h
	g++ -c -Wall -std=c++17 -Isrc/ src/visualize/trash-flow-file-out.cpp -o run/build/visualize_trash-flow-file-out.o
	@echo "run/build/visualize_trash-flow-file-out.o created."
	@echo " "


run/build/visualize_trash-tikz-draw.o: src/visualize/trash-tikz-draw.cpp src/visualize/trash-tikz-draw.h src/global/dst.h
	g++ -c -Wall -std=c++17 -Isrc/ src/visualize/trash-tikz-draw.cpp -o run/build/visualize_trash-tikz-draw.o
	@echo "run/build/visualize_trash-tikz-draw.o created."
	@echo " "
