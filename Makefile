...
edit:
	geany -i  src/exe/simulate.cpp src/generator/ic.h src/generator/ic.cpp src/global/constants.h src/global/dst.h src/global/filenames.h src/nst/node.h src/nst/node.cpp src/nst/tube.h src/nst/tube.cpp src/plot/flow.h src/plot/flow.cpp src/print/helloworld.h src/print/helloworld.cpp


run/simulate.exe: run/build/exe_simulate.o run/build/generator_ic.o run/build/nst_node.o run/build/nst_tube.o run/build/plot_flow.o run/build/print_helloworld.o
	g++  run/build/exe_simulate.o run/build/generator_ic.o run/build/nst_node.o run/build/nst_tube.o run/build/plot_flow.o run/build/print_helloworld.o -o run/simulate.exe
