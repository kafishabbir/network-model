...
run/build/nst_state.o: src/nst/state.cpp src/nst/state.h src/global/decl.h
...
run/build/utility_measure.o: src/utility/measure.cpp src/utility/measure.h src/global/decl.h
