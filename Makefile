...
edit:
	geany -i  src/dst/measured.cpp src/dst/measured.h src/dst/parameter.cpp src/dst/parameter.h src/dst/state.cpp src/dst/state.h src/dst/system.cpp src/dst/system.h src/dst/system-output.cpp src/dst/system-output.h src/exe/simulate.cpp src/global/decl.h src/ic/geometry-base.cpp src/ic/geometry-base.h src/ic/geometry-flow.cpp src/ic/geometry-flow.h src/ic/geometry-multiple-tubes-between-nodes.cpp src/ic/geometry-multiple-tubes-between-nodes.h src/ic/geometry-rand.cpp src/ic/geometry-rand.h src/nst/node.cpp src/nst/node.h src/nst/tank.cpp src/nst/tank.h src/nst/tube.cpp src/nst/tube.h src/output-raster/cairo.cpp src/output-raster/cairo.h src/output-raster/flow.cpp src/output-raster/flow.h src/output-vector/draw.cpp src/output-vector/draw.h src/output-vector/flow.cpp src/output-vector/flow.h src/output-vector/label-node.cpp src/output-vector/label-node.h src/output-vector/label-tube.cpp src/output-vector/label-tube.h src/output-vector/tikz.cpp src/output-vector/tikz.h src/output/json.cpp src/output/json.h src/output/latex.cpp src/output/latex.h src/output/property.cpp src/output/property.h src/output/result.cpp src/output/result.h src/output/visual-dimension.cpp src/output/visual-dimension.h src/program/debug-flow.cpp src/program/debug-flow.h src/program/flow-in-periodic-medium.cpp src/program/flow-in-periodic-medium.h src/program/flow-with-divided-tubes.cpp src/program/flow-with-divided-tubes.h src/program/function-trial.cpp src/program/function-trial.h src/program/isolated-imbibition.cpp src/program/isolated-imbibition.h src/program/overlapping-tubes-of-differing-radii.cpp src/program/overlapping-tubes-of-differing-radii.h src/program/permeability.cpp src/program/permeability.h src/program/triangle-closed.cpp src/program/triangle-closed.h src/simulate/accuracy.cpp src/simulate/accuracy.h src/simulate/assign.cpp src/simulate/assign.h src/simulate/measure.cpp src/simulate/measure.h src/simulate/menu.cpp src/simulate/menu.h src/simulate/preparation.cpp src/simulate/preparation.h src/simulate/set-solver.cpp src/simulate/set-solver.h src/simulate/system-generator.cpp src/simulate/system-generator.h src/step/all-parts.cpp src/step/all-parts.h src/step/part01-reference.cpp src/step/part01-reference.h src/step/part02-pressure.cpp src/step/part02-pressure.h src/step/part03-velocity.cpp src/step/part03-velocity.h src/step/part04-time.cpp src/step/part04-time.h src/step/part05-displacement.cpp src/step/part05-displacement.h src/step/part06-pour.cpp src/step/part06-pour.h src/step/part07-inject.cpp src/step/part07-inject.h src/step/part08-distribute.cpp src/step/part08-distribute.h src/step/part09-displace.cpp src/step/part09-displace.h src/step/part10-measure.cpp src/step/part10-measure.h src/utility/random.cpp src/utility/random.h src/utility/str.cpp src/utility/str.h src/utility/time.cpp src/utility/time.h


run/simulate.exe: run/build/exe_simulate.o run/build/dst_measured.o run/build/dst_parameter.o run/build/dst_state.o run/build/dst_system.o run/build/dst_system-output.o run/build/ic_geometry-base.o run/build/ic_geometry-flow.o run/build/ic_geometry-multiple-tubes-between-nodes.o run/build/ic_geometry-rand.o run/build/nst_node.o run/build/nst_tank.o run/build/nst_tube.o run/build/output-raster_cairo.o run/build/output-raster_flow.o run/build/output-vector_draw.o run/build/output-vector_flow.o run/build/output-vector_label-node.o run/build/output-vector_label-tube.o run/build/output-vector_tikz.o run/build/output_json.o run/build/output_latex.o run/build/output_property.o run/build/output_result.o run/build/output_visual-dimension.o run/build/program_debug-flow.o run/build/program_flow-in-periodic-medium.o run/build/program_flow-with-divided-tubes.o run/build/program_function-trial.o run/build/program_isolated-imbibition.o run/build/program_overlapping-tubes-of-differing-radii.o run/build/program_permeability.o run/build/program_triangle-closed.o run/build/simulate_accuracy.o run/build/simulate_assign.o run/build/simulate_measure.o run/build/simulate_menu.o run/build/simulate_preparation.o run/build/simulate_set-solver.o run/build/simulate_system-generator.o run/build/step_all-parts.o run/build/step_part01-reference.o run/build/step_part02-pressure.o run/build/step_part03-velocity.o run/build/step_part04-time.o run/build/step_part05-displacement.o run/build/step_part06-pour.o run/build/step_part07-inject.o run/build/step_part08-distribute.o run/build/step_part09-displace.o run/build/step_part10-measure.o run/build/utility_random.o run/build/utility_str.o run/build/utility_time.o
	g++ -fopenmp  run/build/exe_simulate.o run/build/dst_measured.o run/build/dst_parameter.o run/build/dst_state.o run/build/dst_system.o run/build/dst_system-output.o run/build/ic_geometry-base.o run/build/ic_geometry-flow.o run/build/ic_geometry-multiple-tubes-between-nodes.o run/build/ic_geometry-rand.o run/build/nst_node.o run/build/nst_tank.o run/build/nst_tube.o run/build/output-raster_cairo.o run/build/output-raster_flow.o run/build/output-vector_draw.o run/build/output-vector_flow.o run/build/output-vector_label-node.o run/build/output-vector_label-tube.o run/build/output-vector_tikz.o run/build/output_json.o run/build/output_latex.o run/build/output_property.o run/build/output_result.o run/build/output_visual-dimension.o run/build/program_debug-flow.o run/build/program_flow-in-periodic-medium.o run/build/program_flow-with-divided-tubes.o run/build/program_function-trial.o run/build/program_isolated-imbibition.o run/build/program_overlapping-tubes-of-differing-radii.o run/build/program_permeability.o run/build/program_triangle-closed.o run/build/simulate_accuracy.o run/build/simulate_assign.o run/build/simulate_measure.o run/build/simulate_menu.o run/build/simulate_preparation.o run/build/simulate_set-solver.o run/build/simulate_system-generator.o run/build/step_all-parts.o run/build/step_part01-reference.o run/build/step_part02-pressure.o run/build/step_part03-velocity.o run/build/step_part04-time.o run/build/step_part05-displacement.o run/build/step_part06-pour.o run/build/step_part07-inject.o run/build/step_part08-distribute.o run/build/step_part09-displace.o run/build/step_part10-measure.o run/build/utility_random.o run/build/utility_str.o run/build/utility_time.o -o run/simulate.exe -lcairo
...
run/build/ic_geometry-multiple-tubes-between-nodes.o: src/ic/geometry-multiple-tubes-between-nodes.cpp src/ic/geometry-multiple-tubes-between-nodes.h src/global/decl.h
	g++ -c -Wall -std=c++17 -Isrc/ -fopenmp src/ic/geometry-multiple-tubes-between-nodes.cpp -o run/build/ic_geometry-multiple-tubes-between-nodes.o
	@echo "run/build/ic_geometry-multiple-tubes-between-nodes.o created."
	@echo " "
...
run/build/program_overlapping-tubes-of-differing-radii.o: src/program/overlapping-tubes-of-differing-radii.cpp src/program/overlapping-tubes-of-differing-radii.h src/global/decl.h
	g++ -c -Wall -std=c++17 -Isrc/ -fopenmp src/program/overlapping-tubes-of-differing-radii.cpp -o run/build/program_overlapping-tubes-of-differing-radii.o
	@echo "run/build/program_overlapping-tubes-of-differing-radii.o created."
	@echo " "
