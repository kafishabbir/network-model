...
\begin{scope}
	...
	\fill[cw] (\pos1 * \l, \d/2) rectangle (\pos2 * \l, -\d/2);
\end{scope}
...
\begin{scope}
	...
	\tikzmath{
		\meniscuspos = 0.7; %in 0-1 coordinates
		\meniscusrot = 0; %0=) 180=(
	}
	%drawing meniscus
...
\end{scope}
			...
			\begin{scope}
				%SET MENISCUS POSITION
				\tikzmath{
					\meniscuspos = 0.9; %in 0-1 coordinates
			...
			\begin{scope}
				...
				\fill[cdw] (\pos1 * \l, \d/2) rectangle (\pos2 * \l, -\d/2);
			\end{scope}
			...
			\begin{scope}
				%SET MENISCUS POSITION
				\tikzmath{
					\meniscuspos = 0.3; %in 0-1 coordinates
					\meniscusrot = 0; %0=) 180=(
				}
				%drawing meniscus
				\begin{scope}[shift={(\meniscuspos*\l,0)}]
					\begin{scope}[rotate=\meniscusrot]
						\begin{scope}[shift={(-\d/4,0)}]
							\fill[cdw] (0, \d / 2) rectangle (\d/2 + \small, -\d / 2);
			...
			\begin{scope}
				%SET MENISCUS POSITION
				\tikzmath{
					\meniscuspos = 0.5; %in 0-1 coordinates
					\meniscusrot = 180; %0=) 180=(
				}
				%drawing meniscus
				\begin{scope}[shift={(\meniscuspos*\l,0)}]
			...
			\node[] at (0.4*\l, -1.5) {$+V_w = 0.3$};
			\node[] at (0.4*\l, -2.2) {$+V_{nw} = 0.4$};
		\end{scope}
	\end{scope}
	...
	\begin{scope}[rotate=135]
		...
		\begin{scope}[shift={(\pr, 0)}]
			...
			\begin{scope}
				%SET MENISCUS POSITION
				\tikzmath{
					\meniscuspos = 0.8; %in 0-1 coordinates
					\meniscusrot = 180; %0=) 180=(
				}
				%drawing meniscus
				\begin{scope}[shift={(\meniscuspos*\l,0)}]
