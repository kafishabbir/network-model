...
\begin{scope}[rotate=-45]
	...
	\begin{scope}[rotate=45]
		...
		\begin{scope}[shift={(\pr, 0)}]
			...
			\begin{scope}
				%SET MENISCUS POSITION
				\tikzmath{
					\meniscuspos = 0.6; %in 0-1 coordinates
			...
			\node[] at (0.6*\l, -0.6) {$+V_w = 0,5$};
			\node[] at (0.6*\l, -1.2) {$+V_{nw} = 0,3$};
		\end{scope}
	\end{scope}
	...
	\begin{scope}[rotate=-135]
		...
		\begin{scope}[shift={(\pr, 0)}]
			...
			\draw[] (0, -\d/2) -- (\l, -\d/2);
			\draw[<-, thick] (0.1*\l, 0) -- (0.4*\l, 0);
			\node[] at (0.6*\l, -0.7) {$-V_w = 0,7$};
			\draw[] (0.9 * \l, 0) -- (1 * \l, - 2*\d) node[above] {$1$};
		\end{scope}
	\end{scope}
\end{scope}
\end{tikzpicture}
